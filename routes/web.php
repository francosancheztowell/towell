...
Route::get('/planeacion/programa-tejido/liberar-ordenes/hilo-ax-modelos', [LiberarOrdenesController::class, 'obtenerHiloAXDesdeModelos'])->name('programa-tejido.liberar-ordenes.hilo-ax-modelos');
