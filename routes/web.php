...
Route::get('/planeacion/programa-tejido/liberar-ordenes/bom-sugerencias', [LiberarOrdenesController::class, 'buscarBom'])->name('programa-tejido.liberar-ordenes.bom');
