 ...
 * de los dos endpoints /turno-info, que deben seguir igual tras la fase 20-01.
 */
class TurnoHelperTest extends TestCase
{
    ...
    #[DataProvider('turnosInfo')]
    public function test_turno_info_de_nuevo_requerimiento(string $mexico, string $turno, string $horario, string $formato): void
    {
        ...
        DB::table('dbo.SSYSFoliosSecuencias')->insert(['modulo' => 'Trama', 'prefijo' => 'TR', 'consecutivo' => 7]);
        Carbon::setTestNow(Carbon::parse($mexico, 'America/Mexico_City'));

        $respuesta = app(NuevoRequerimientoController::class)->getTurnoInfo();
