...
class SimulacionProgramaTejidoLine extends Model
{
    use HasFactory;

    protected $table = 'dbo.SimulacionProgramaTejidoLine';
    ...
    {
        return $this->belongsTo(SimulacionProgramaTejido::class, 'ProgramaId', 'Id');
    }
