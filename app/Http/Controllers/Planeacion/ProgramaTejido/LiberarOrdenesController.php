...
use App\Services\Planeacion\Liberar\LiberarCamposEditablesService;
...
class LiberarOrdenesController extends Controller
{
    ...
    public function __construct(
        ...
        private readonly LiberarCamposEditablesService $camposEditables = new LiberarCamposEditablesService,
    ) {}
     ...
     * Delega validación y persistencia a {@see LiberarCamposEditablesService}.
     */
    public function guardarCamposEditables(Request $request)
    {
        AuditoriaHelper::contexto('EDITAR_LIBERAR');

        return $this->camposEditables->guardar($request);
    }
