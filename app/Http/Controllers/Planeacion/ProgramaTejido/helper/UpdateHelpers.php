...
class UpdateHelpers
{
    ...
    {
        if (array_key_exists('peso_grm2', $d)) {
            $r->PesoGRM2 = is_null($d['peso_grm2']) ? null : (float) $d['peso_grm2'];
        }
        if (array_key_exists('dias_eficiencia', $d)) {
            $r->DiasEficiencia = $d['dias_eficiencia'];
        }
        if (array_key_exists('prod_kg_dia', $d)) {
            $r->ProdKgDia = $d['prod_kg_dia'];
        }
        if (array_key_exists('std_dia', $d)) {
            $r->StdDia = $d['std_dia'];
        }
        if (array_key_exists('prod_kg_dia2', $d)) {
            $r->ProdKgDia2 = $d['prod_kg_dia2'];
        }
        if (array_key_exists('std_toa_hra', $d)) {
            $r->StdToaHra = $d['std_toa_hra'];
        }
        if (array_key_exists('dias_jornada', $d)) {
            $r->DiasJornada = $d['dias_jornada'];
        }
        if (array_key_exists('horas_prod', $d)) {
            $r->HorasProd = $d['horas_prod'];
        }
        if (array_key_exists('std_hrs_efect', $d)) {
            $r->StdHrsEfect = $d['std_hrs_efect'];
        }
    }
    ...
    {
        // Nombres
        if (array_key_exists('nombre_color_1', $d)) {
            $r->NombreCC1 = $d['nombre_color_1'];
        }
        if (array_key_exists('nombre_color_2', $d)) {
            $r->NombreCC2 = $d['nombre_color_2'];
        }
        if (array_key_exists('nombre_color_3', $d)) {
            $r->NombreCC3 = $d['nombre_color_3'];
        }
        if (array_key_exists('nombre_color_6', $d)) {
            $r->NombreCC5 = $d['nombre_color_6'];
        }

        // Calibres
        if (array_key_exists('calibre_trama', $d)) {
            $r->CalibreTrama = $d['calibre_trama'];
        }
        if (array_key_exists('calibre_c1', $d)) {
            $r->CalibreComb12 = $d['calibre_c1'];
        }
        if (array_key_exists('calibre_c2', $d)) {
            $r->CalibreComb22 = $d['calibre_c2'];
        }
        if (array_key_exists('calibre_c3', $d)) {
            $r->CalibreComb32 = $d['calibre_c3'];
        }
        if (array_key_exists('calibre_c4', $d)) {
            $r->CalibreComb42 = $d['calibre_c4'];
        }
        if (array_key_exists('calibre_c5', $d)) {
            $r->CalibreComb52 = $d['calibre_c5'];
        }

        // Fibras
        if (array_key_exists('fibra_trama', $d)) {
            $r->FibraTrama = $d['fibra_trama'];
        }
        if (array_key_exists('fibra_c1', $d)) {
            $r->FibraComb1 = $d['fibra_c1'];
        }
        if (array_key_exists('fibra_c2', $d)) {
            $r->FibraComb2 = $d['fibra_c2'];
        }
        if (array_key_exists('fibra_c3', $d)) {
            $r->FibraComb3 = $d['fibra_c3'];
        }
        if (array_key_exists('fibra_c4', $d)) {
            $r->FibraComb4 = $d['fibra_c4'];
        }
        if (array_key_exists('fibra_c5', $d)) {
            $r->FibraComb5 = $d['fibra_c5'];
        }

        // Códigos
        if (array_key_exists('cod_color_1', $d)) {
            $r->CodColorTrama = $d['cod_color_1'];
        }
        if (array_key_exists('cod_color_2', $d)) {
            $r->CodColorComb2 = $d['cod_color_2'];
        }
        if (array_key_exists('cod_color_3', $d)) {
            $r->CodColorComb4 = $d['cod_color_3'];
        }
        if (array_key_exists('cod_color_4', $d)) {
            $r->CodColorComb1 = $d['cod_color_4'];
        }
        if (array_key_exists('cod_color_5', $d)) {
            $r->CodColorComb3 = $d['cod_color_5'];
        }
        if (array_key_exists('cod_color_6', $d)) {
            $r->CodColorComb5 = $d['cod_color_6'];
        }
    }
