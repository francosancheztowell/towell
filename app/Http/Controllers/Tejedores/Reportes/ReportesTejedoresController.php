...
use App\Exports\TejedoresReporteExport;
use App\Http\Controllers\Controller;
use Carbon\Carbon;
use Illuminate\Http\Request;
use Maatwebsite\Excel\Facades\Excel;

class ReportesTejedoresController extends Controller
{
    /**
    ...
    public function index()
    {
        $reportes = [
            [
                'nombre' => 'Reporte BPM Tejedores',
                'accion' => 'Pedir Rango de Fechas',
                'url' => route('tejedores.reportes-tejedores.programa'),
                'disponible' => true,
            ],
        ];

        return view('modulos.tejedores.reportes.index', ['reportes' => $reportes]);
    }

    /**
     * Vista del reporte BPM Tejedores con filtros de fecha
     */
    ...
    /**
     * Exportar Excel del Reporte BPM Tejedores
     */
