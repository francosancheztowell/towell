...
class SimulacionProgramaTejidoLineController extends Controller
{
    /* -------------------- Reglas compartidas -------------------- */
    private function rules(bool $isUpdate = false): array
    {
        ...
        $progRule = ['integer','exists:dbo.SimulacionProgramaTejido,Id'];
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $q = SimulacionProgramaTejidoLine::query();
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $created = SimulacionProgramaTejidoLine::create($data);
    ...
    {
        $row = SimulacionProgramaTejidoLine::findOrFail($id);
