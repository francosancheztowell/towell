...
class LimpiarPrefijosTelaresVelocidad extends Command
{
     ...
     * @var string
     */
    protected $signature = 'velocidad:limpiar-prefijos';
     ...
     * @var string
     */
    protected $description = 'Limpia los prefijos de los telares en la tabla de velocidad (JAC 201 → 201)';
    ...
    {
        $this->info('Iniciando limpieza de prefijos de telares en velocidad...');
        ...
        try {
            ...
            $registros = ReqVelocidadStd::whereRaw("NoTelarId LIKE '% %'")->get();
