...
// Las URL van con la ruta de Programa a propósito: el parche de fetch de index.js
// las reescribe a la superficie actual (Muestras), igual que antes.
// notify es el global de bootstrap.js (resources/js/utils/notifications.ts).
  ...
  window.aplicarBalanceoAutomatico = async function (ordCompartida) {
    ...
    try {
      ...
      if (data.advertencia_total) {
        notify.warning(data.advertencia_total);
      }
