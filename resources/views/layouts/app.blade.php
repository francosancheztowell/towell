    ...
    <div class="relative bg-white rounded-lg shadow-xl max-w-5xl w-full mx-4 my-8">
      ...
      <div class="p-6">
        ...
        <div id="tablaProduccionCortadoContainer" class="mb-6" style="display: none;">
          <h3 class="text-lg font-semibold text-gray-800 mb-3">Seleccionar Marbete a Liberar</h3>
          <div class="overflow-x-auto overflow-y-auto max-h-[60vh] relative">
      ...
      function renderizarTablaCortado(datos) {
        ...
        datos.forEach((dato, index) => {
          ...
          row.innerHTML = `
            ...
            <td class="px-4 py-2 text-sm text-gray-900">${formatearPiezas(dato.QtySched)}</td>
