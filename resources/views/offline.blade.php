...
<head>
    ...
    <title>Sin conexion - Towell</title>
...
<body class="min-h-screen bg-blue-300 flex items-center justify-center p-4">
    <div class="max-w-md w-full text-center">
        <picture>
            ...
            <img src="{{ asset('images/fotos_usuarios/towelin404.png') }}" alt="Sin conexion" width="700" height="906" decoding="async" class="h-56 w-auto mx-auto mb-6">
        </picture>
        <h1 class="text-3xl font-bold text-white mb-4">Sin conexion</h1>
        <p class="text-white mb-6">No hay conexion a internet disponible.</p>
