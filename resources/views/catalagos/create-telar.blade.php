        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
                        <i class="fas fa-plus-circle me-2"></i>Crear Nuevo Telar
                    </h5>
                </div>
                <div class="card-body">
                    @if(session('success'))
                    ...
                    <form action="{{ route('planeacion.telares.store') }}" method="POST">
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <button type="submit" class="btn btn-success" onclick="confirmarCreacion()">
                                <i class="fas fa-save me-2"></i>Crear Telar
                            </button>
                        </div>
                    </form>
                </div>
