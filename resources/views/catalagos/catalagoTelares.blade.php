...
function enableButtons(){
  ...
  if (e) { e.disabled=false; e.className='inline-flex items-center px-3 py-2 bg-yellow-600 hover:bg-yellow-700 text-white rounded-lg text-sm font-medium'; e.onclick = function() { console.log('Botón editar clickeado'); editarTelar(); }; }
  if (d) { d.disabled=false; d.className='inline-flex items-center px-3 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg text-sm font-medium'; d.onclick = function() { console.log('Botón eliminar clickeado'); eliminarTelar(); }; }
}
function disableButtons(){
  console.log('disableButtons llamado');
  const e = document.getElementById('btn-editar');
  const d = document.getElementById('btn-eliminar');
   if (e) { e.disabled=true; e.className='inline-flex items-center px-3 py-2 bg-gray-400 text-gray-200 rounded-lg text-sm font-medium cursor-not-allowed'; e.onclick = null; }
  if (d) { d.disabled=true; d.className='inline-flex items-center px-3 py-2 bg-gray-400 text-gray-200 rounded-lg text-sm font-medium cursor-not-allowed'; d.onclick = null; }
}
