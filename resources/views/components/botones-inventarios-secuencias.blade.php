@props([
    'modulo' => '', // Nombre del módulo para permisos (ej: 'Secuencia Inv Telas', 'Secuencia Inv Trama')
    'onCreate' => '', // Función JavaScript para crear (ej: 'agregarSecuenciaInvTelas')
    'onEdit' => '', // Función JavaScript para editar (ej: 'editarSecuenciaInvTelas')
    'onDelete' => '', // Función JavaScript para eliminar (ej: 'eliminarSecuenciaInvTelas')
])
