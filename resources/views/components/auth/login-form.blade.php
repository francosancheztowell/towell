{{--
    ...
    Descripción:
        Formulario de inicio de sesión reutilizable con validación y autenticación.
    ...
    <form id="loginForm" method="{{ $method }}" action="{{ $action }}">
        ...
        <div class="mb-5">
            ...
            <div class="relative">
                ...
                >
                    <svg id="eyeClosed" aria-hidden="true" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                    </svg>
                    <svg id="eyeOpen" aria-hidden="true" class="w-5 h-5 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
