    ...
    <form id="formDesarrollador" method="POST" action="{{ route('desarrolladores.store') }}">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <input type="number" id="TotalPasadasDibujo" name="TotalPasadasDibujo" min="1" step="1" required readonly class="w-full px-2 py-2 border border-gray-300 rounded-lg bg-gray-50 text-sm" placeholder="0">
            </div>
