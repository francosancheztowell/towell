<div class="md:col-span-2">
    ...
    <div id="ordenEnProcesoBanner" class="hidden mb-3 p-3 bg-blue-500 border border-blue-600 rounded-lg">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-2">
                ...
                <span class="text-sm font-semibold text-white">Orden en Proceso:</span>
                <span id="ordenEnProcesoNum" class="text-sm font-bold text-white">-</span>
                <span id="ordenEnProcesoNombre" class="text-xs text-blue-100">-</span>
            </div>
            <button type="button" id="btnCerrarBannerEnProceso" class="text-blue-200 hover:text-white transition-colors" title="Cerrar">
            ...
            <table class="w-full divide-y divide-red-200">
                <thead class="bg-blue-500">
                    <tr>
                        ...
                        <th scope="col" class="px-3 py-2 text-center text-sm font-medium text-white">Reprogramar</th>
                    </tr>
                </thead>
