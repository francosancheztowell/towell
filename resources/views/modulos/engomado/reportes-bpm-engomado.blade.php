...
@section('navbar-right')
    <button type="button" onclick="mostrarModalConsultarBpmEngomado()"
...
@push('scripts')
<script>
    function mostrarModalConsultarBpmEngomado() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed && result.value) {
                ...
                window.location.href = '{{ route("engomado.reportes.bpm") }}?' + params.toString();
            }
        });
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        @if (empty($fechaIni) || empty($fechaFin))
        mostrarModalConsultarBpmEngomado();
        @endif
    });
</script>
@endpush
