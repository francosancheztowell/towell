...
<div class="flex items-center gap-1">
    <button id="btn-agregar" onclick="agregarSecuenciaInvTelas()"
    ...
    <button id="btn-editar" onclick="editarSecuenciaInvTelas()" disabled
    ...
    <button id="btn-eliminar" onclick="eliminarSecuenciaInvTelas()" disabled
