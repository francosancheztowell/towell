...
<div class="flex items-center gap-1">
    <button id="btn-agregar" onclick="agregarSecuenciaInvTrama()"
    ...
    <button id="btn-editar" onclick="editarSecuenciaInvTrama()" disabled
    ...
    <button id="btn-eliminar" onclick="eliminarSecuenciaInvTrama()" disabled
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        <div class="overflow-x-auto h-[600px]">
            <table id="mainTable" class="border-collapse w-full">
                ...
                <tbody id="secuencia-inv-trama-body" class="bg-white text-black">
...
function selectRow(row, id) {
    document.querySelectorAll('#secuencia-inv-trama-body tr').forEach(r => {
