            ...
            <div class="overflow-y-auto" style="max-height: 600px;">
                <table class="min-w-full table-fixed divide-y divide-gray-200 text-xs leading-tight">
                    <thead class="bg-blue-500 text-white sticky top-0 z-10">
                        <tr>
                            <th class="px-2 py-2 text-left font-semibold whitespace-nowrap w-20 cursor-pointer hover:bg-blue-600" onclick="toggleSort('flog')">
                                Flog <i id="sortIcon-flog" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>
                            <th class="px-2 py-2 text-left font-semibold whitespace-nowrap w-36 cursor-pointer hover:bg-blue-600" onclick="toggleSort('proyecto')">
                                Proyecto <i id="sortIcon-proyecto" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>
                            <th class="px-2 py-2 text-left font-semibold whitespace-nowrap w-36 cursor-pointer hover:bg-blue-600" onclick="toggleSort('cliente')">
                                Cliente <i id="sortIcon-cliente" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>
                            <th class="px-2 py-2 text-left font-semibold whitespace-nowrap w-24 cursor-pointer hover:bg-blue-600" onclick="toggleSort('calidad')">
                                Calidad <i id="sortIcon-calidad" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>
                            <th class="px-2 py-2 text-left font-semibold whitespace-nowrap w-16 cursor-pointer hover:bg-blue-600" onclick="toggleSort('ancho')">
                                Ancho <i id="sortIcon-ancho" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>
                            <th class="px-2 py-2 text-left font-semibold whitespace-nowrap w-16 cursor-pointer hover:bg-blue-600" onclick="toggleSort('largo')">
                                Largo <i id="sortIcon-largo" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>
                            <th class="px-2 py-2 text-left font-semibold whitespace-nowrap w-28 cursor-pointer hover:bg-blue-600" onclick="toggleSort('articulo')">
                                Artículo <i id="sortIcon-articulo" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>
                            <th class="px-2 py-2 text-left font-semibold whitespace-nowrap w-44 cursor-pointer hover:bg-blue-600" onclick="toggleSort('nombre')">
                                Nombre <i id="sortIcon-nombre" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>
                            <th class="px-2 py-2 text-left font-semibold whitespace-nowrap w-20 cursor-pointer hover:bg-blue-600" onclick="toggleSort('tamano')">
                                Tamaño <i id="sortIcon-tamano" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>
                            <th class="px-2 py-2 text-left font-semibold whitespace-nowrap w-24 cursor-pointer hover:bg-blue-600" onclick="toggleSort('razurado')">
                                Rasurado <i id="sortIcon-razurado" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>
                            <th class="px-2 py-2 text-left font-semibold whitespace-nowrap w-20 cursor-pointer hover:bg-blue-600" onclick="toggleSort('hilo')">
                                Hilo <i id="sortIcon-hilo" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>
                            <th class="px-2 py-2 text-left font-semibold whitespace-nowrap w-24 cursor-pointer hover:bg-blue-600" onclick="toggleSort('valor')">
                                V. Agregado <i id="sortIcon-valor" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>
                            <th class="px-2 py-2 text-left font-semibold whitespace-nowrap w-28 cursor-pointer hover:bg-blue-600" onclick="toggleSort('cancelacion')">
                                Cancelación <i id="sortIcon-cancelacion" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>
                            <th class="px-2 py-2 text-right font-semibold whitespace-nowrap w-20 cursor-pointer hover:bg-blue-600" onclick="toggleSort('cantidad')">
        ...
        const html = `
            <div class="text-left text-sm">
                ...
                <div class="mb-1 relative">
                    ...
                    <input id="swal-clave" type="text" placeholder="Escriba la clave..." class="w-full px-3 py-2 border border-gray-300 rounded focus:ring-1 focus:ring-blue-500 focus:border-blue-500 text-sm" autocomplete="off" />
