...
@section('content')
            ...
            <div class="text-center">
                ...
                <div class="flex justify-center mb-6">
                    <div class="relative inline-block">
                        <div id="qrcode" class="p-4 bg-white border-4 border-gray-200 rounded-lg shadow-md"
                            data-qr-text="{{ $usuario->numero_empleado }}"
                            data-qr-logo="{{ asset('images/fotos_usuarios/TOWELLIN.webp') }}"
                            data-qr-filename="QR_{{ $usuario->numero_empleado }}_{{ str_replace(' ', '_', $usuario->nombre) }}.png"></div>
                ...
                <!-- Download Button -->
                <button type="button" data-qr-download
    ...
    @vite('resources/js/usuarios/qr.ts')
@endsection
