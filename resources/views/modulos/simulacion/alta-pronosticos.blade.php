...
@section('page-title', 'Simulación - Alta de Pronósticos')

@section('navbar-right')
    <x-navbar.button-create id="btnProgramar" onclick="handleProgramarPronosticos()" title="Programar" module="Simulación" icon="fa-calendar-check" bg="bg-gray-400" iconColor="text-white" hoverBg="hover:bg-gray-500" disabled />
...
<div class="w-full px-0 py-0">
    <div class="bg-white shadow overflow-hidden w-full">
        ...
        <div id="loadingState" class="flex flex-col items-center justify-center py-20 w-full">
            <div class="animate-spin rounded-full h-16 w-16 border-4 border-stone-200 border-t-stone-600 mb-4"></div>
            ...
            <div class="overflow-y-auto" style="max-height: 600px;">
                <table class="w-full divide-y divide-gray-200 text-xs leading-tight" id="tablaPronosticos" style="table-layout: fixed; width: 100%;">
                    <thead class="bg-stone-500 text-white sticky top-0 z-10">
                        <tr>
                            <th class="px-1 py-2 text-left font-semibold whitespace-nowrap cursor-pointer hover:bg-stone-600" style="width: 12%;" onclick="toggleSort('flog')">
                                Flog <i id="sortIcon-flog" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>

                            <th class="px-1 py-2 text-left font-semibold whitespace-nowrap cursor-pointer hover:bg-stone-600" style="width: 10%;" onclick="toggleSort('proyecto')">
                                Proyecto <i id="sortIcon-proyecto" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>
                            <th class="px-1 py-2 text-left font-semibold whitespace-nowrap cursor-pointer hover:bg-stone-600" style="width: 8%;" onclick="toggleSort('cliente')">
                                Cliente <i id="sortIcon-cliente" class="fa-solid fa-sort-up ml-1 text-xs"></i>
                            </th>
                            <th class="px-1 py-2 text-left font-semibold whitespace-nowrap cursor-pointer hover:bg-stone-600" style="width: 6%;" onclick="toggleSort('calidad')">
                                Calidad <i id="sortIcon-calidad" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>
                            <th class="px-1 py-2 text-left font-semibold whitespace-nowrap cursor-pointer hover:bg-stone-600" style="width: 5%;" onclick="toggleSort('ancho')">
                                Ancho <i id="sortIcon-ancho" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>
                            <th class="px-1 py-2 text-left font-semibold whitespace-nowrap cursor-pointer hover:bg-stone-600" style="width: 5%;" onclick="toggleSort('largo')">
                                Largo <i id="sortIcon-largo" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>
                            <th class="px-1 py-2 text-left font-semibold whitespace-nowrap cursor-pointer hover:bg-stone-600" style="width: 6%;" onclick="toggleSort('articulo')">
                                Artículo <i id="sortIcon-articulo" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>
                            <th class="px-1 py-2 text-left font-semibold whitespace-nowrap cursor-pointer hover:bg-stone-600" style="width: 10%;" onclick="toggleSort('nombre')">
                                Nombre <i id="sortIcon-nombre" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>
                            <th class="px-1 py-2 text-left font-semibold whitespace-nowrap cursor-pointer hover:bg-stone-600" style="width: 5%;" onclick="toggleSort('tamano')">
                                Tamaño <i id="sortIcon-tamano" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>
                            <th class="px-1 py-2 text-left font-semibold whitespace-nowrap cursor-pointer hover:bg-stone-600" style="width: 6%;" onclick="toggleSort('razurado')">
                                Rasurado <i id="sortIcon-razurado" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>
                            <th class="px-1 py-2 text-left font-semibold whitespace-nowrap cursor-pointer hover:bg-stone-600" style="width: 6%;" onclick="toggleSort('tipohilo')">
                                Hilo <i id="sortIcon-tipohilo" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>
                            <th class="px-1 py-2 text-left font-semibold whitespace-nowrap cursor-pointer hover:bg-stone-600" style="width: 7%;" onclick="toggleSort('valoragregado')">
                                V.Agreg. <i id="sortIcon-valoragregado" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>
                            <th class="px-1 py-2 text-right font-semibold whitespace-nowrap cursor-pointer hover:bg-stone-600" style="width: 6%;" onclick="toggleSort('cantidad')">
                                Cantidad <i id="sortIcon-cantidad" class="fa-solid fa-sort ml-1 text-xs"></i>
                            </th>
                            <th class="px-1 py-2 text-left font-semibold whitespace-nowrap cursor-pointer hover:bg-stone-600" style="width: 7%;" onclick="toggleSort('cancelacion')">
...
<script>
    ...
    function renderRows(data) {
        ...
        data.forEach((x, index) => {
            const tr = document.createElement('tr');
            tr.className = 'select-row cursor-pointer even:bg-gray-50 hover:bg-stone-50 transition-colors';
    ...
    function selectRow(rowElement, rowData, index) {
        ...
        if (selectedRow) {
            selectedRow.classList.remove('bg-stone-500', 'text-white');
        ...
        rowElement.classList.remove('even:bg-gray-50', 'hover:bg-stone-50');
        ...
        if (btnProgramar) {
            ...
            btnProgramar.classList.add('bg-stone-600', 'hover:bg-stone-700', 'cursor-pointer');
        }
    }
    ...
    function deselectRow() {
        ...
        if (btnProgramar) {
            ...
            btnProgramar.classList.remove('bg-stone-600', 'hover:bg-stone-700', 'cursor-pointer');
                ...
                const html = `
                    <div class="text-left text-sm">
                        ...
                        <div class="mb-1 relative">
                            ...
                            <input id="swal-clave-modelo" type="text" placeholder="Escriba la clave..." class="w-full px-3 py-2 border border-gray-300 rounded focus:ring-1 focus:ring-stone-500 focus:border-stone-500 text-sm" autocomplete="off" />
            ...
            const html = `
                <div class="text-left">
                    ...
                    <button type="button" id="btnAgregarFiltro"
                            class="w-full bg-stone-600 hover:bg-stone-700 text-white px-4 py-2 rounded text-sm">
