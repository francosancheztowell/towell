...
<div class="flex items-center space-x-2">
    <button id="btn-nuevo" class="inline-flex items-center px-3 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors text-sm font-medium">
        <i class="fas fa-plus mr-1"></i>Nuevo
    </button>
    <button id="btn-editar" class="inline-flex items-center px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors text-sm font-medium" disabled>
        <i class="fas fa-edit mr-1"></i>Editar
    </button>
    <button id="btn-finalizar" class="inline-flex items-center px-3 py-2 bg-orange-600 hover:bg-orange-700 text-white rounded-lg transition-colors text-sm font-medium" disabled>
