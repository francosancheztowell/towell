                            ...
                            <table class="w-full table-auto border-collapse">
                                <thead class="sticky top-0 bg-gray-100 z-10">
                                    <tr class="bg-gray-100 h-6 leading-6">
                                        @php
                                            $thBaseClasses = 'px-2 py-0 text-center font-semibold text-xs border border-gray-300 align-middle h-6 leading-6';
                                        @endphp
        ...
        (() => {
            ...
            const renderTable = (mccoy) => {
                ...
                if (!ordenes.length) {
                    tbody.innerHTML = `
                        <tr>
                            <td colspan="6" class="px-2 py-2 text-center text-gray-500 text-sm">
                ...
                const baseTd =
                    'px-2 py-0 text-xs border border-gray-300 whitespace-nowrap align-middle h-9 leading-9';
